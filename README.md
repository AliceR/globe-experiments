...
ESLint is configured with Prettier integration, so formatting issues are caught during linting:

- Prettier rules are enforced as ESLint errors
- `npm run fix` will automatically fix both linting and formatting issues
